################################################################
####  Figure S8 : Multiple  ETCCDI indices and time window  ####
################################################################
...
################################################################
# Extract coefficients and confidence intervals, rename coefficients names and compute sample mean
################################################################
...
# Run the main regression to identify the observation from which we compute the sample mean 
...
ggsave(file = paste(output_path, "Figures/ols_fe_dhs_cbd_n_cutoff_nd_0_lag_combined_ETCCDI.pdf", sep = ""), width=16, height=8)
