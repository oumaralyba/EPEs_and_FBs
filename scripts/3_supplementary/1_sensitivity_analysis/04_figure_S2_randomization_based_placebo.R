################################################################
###   Figure S2 : Placebo - randomization based placebo      ###
################################################################
...
histogram <- histogram + 
  geom_vline(xintercept =ols_fe_dhs_cbd[["coefficients"]][["prec_85_count_3d_0_lag"]] , linetype = "dashed", color = "red") 
...
# Green lines for percentiles 0.5%, 2.5%, 5%, 95%, 97.5%, 99.5% 
histogram <- histogram +
  geom_vline(xintercept = quantiles["0.5%"], linetype = "dashed", color = "green") +
  geom_vline(xintercept = quantiles["2.5%"], linetype = "dashed", color = "green") +
  geom_vline(xintercept = quantiles["5%"], linetype = "dashed", color = "green") +
  geom_vline(xintercept = quantiles["95%"], linetype = "dashed", color = "green") +
  geom_vline(xintercept = quantiles["97.5%"], linetype = "dashed", color = "green") +
  geom_vline(xintercept = quantiles["99.5%"], linetype = "dashed", color = "green")
...
ggsave("output/Figures/EPEs_85_placebo_distribution_10_000_times.pdf", width = 12, height = 6, units = "in")
