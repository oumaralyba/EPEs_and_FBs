...
################################################################
# Figure S4 : Estimated changes in facility-based births under acute and sustained rainfall exposure models
################################################################
...
# Plot Comparison of % Change between Accumulation and Time Window Models with facet_wrap by percentile thresholdcut_off
ggplot(combined_filtered, 
  ...
  # geom_text_repel(size = 4, box.padding = 0.3, show.legend = FALSE) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +
  geom_vline(xintercept = 0, linetype = "solid", color = "black", alpha = 0.9) +
  geom_hline(yintercept = 0, linetype = "solid", color = "black", alpha = 0.9) +
  scale_color_viridis_d(name = "Sustained and acute \ntime window exposure", labels = function(x) paste0(x, " days"), option = "turbo") +
...
ggsave("output/Figures/ols_fe_dhs_cbd_accumulation_vs_time_window_models.pdf",width=20,height=8*3, units = "in", dpi = 300)
