...
# Extract the confidence interval of model in Table S12 column (3) to mention in the paper 
confint(reg_prec_length_m_quart_bin_interaction, level = 0.95, se = "cluster") 


# Extract p-values for interaction terms of the models in Table S12 
pval_median_dummy <- linearHypothesis(reg_prec_median_length_interaction, "prec_85_count_3d_0_lag:median_length_m_dummy_var0 = prec_85_count_3d_0_lag:median_length_m_dummy_var1") # Table S12 column (2)
pval_q1_q2 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin1 = prec_85_count_3d_0_lag:length_m_quart_bin2") # Table S12 column (3)
pval_q1_q3 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin1 = prec_85_count_3d_0_lag:length_m_quart_bin3") # Table S12 column (3)
pval_q1_q4 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin1 = prec_85_count_3d_0_lag:length_m_quart_bin4") # Table S12 column (3)
pval_q2_q3 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin2 = prec_85_count_3d_0_lag:length_m_quart_bin3") # Table S12 column (3)
pval_q2_q4 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin2 = prec_85_count_3d_0_lag:length_m_quart_bin4") # Table S12 column (3)
pval_q3_q4 <- linearHypothesis(reg_prec_length_m_quart_bin_interaction, "prec_85_count_3d_0_lag:length_m_quart_bin3 = prec_85_count_3d_0_lag:length_m_quart_bin4") # Table S12 column (3)


# Convert the p-values in character
pval_median_dummy <- substr(sprintf("%.8f", pval_median_dummy[2,3]), 1, 6) # Table S12 column (2)
pval_q1_q2 <- substr(sprintf("%.8f", pval_q1_q2[2,3]), 1, 6) # Table S12 column (3)
pval_q1_q3 <- substr(sprintf("%.8f", pval_q1_q3[2,3]), 1, 6) # Table S12 column (3)
pval_q1_q4 <- substr(sprintf("%.8f", pval_q1_q4[2,3]), 1, 6) # Table S12 column (3)
pval_q2_q3 <- substr(sprintf("%.8f", pval_q2_q3[2,3]), 1, 6) # Table S12 column (3)
pval_q2_q4 <- substr(sprintf("%.8f", pval_q2_q4[2,3]), 1, 6) # Table S12 column (3)
pval_q3_q4 <- substr(sprintf("%.8f", pval_q3_q4[2,3]), 1, 6) # Table S12 column (3)
...
texreg(model_list,
       ...
       file = "output/Tables/Table_ols_fe_dhs_cbd_road_interaction.tex"
       )
