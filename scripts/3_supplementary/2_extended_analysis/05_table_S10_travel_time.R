...
# Extract the confidence interval of model in Table S10 column (3) to mention in the paper 
confint(ols_fe_dhs_cbd_quart_tt_bin, level = 0.95, se = "cluster") 

# Extract p-values for interaction terms of the models in Table S10 
pval_median_dummy <- linearHypothesis(ols_fe_dhs_cbd_med_dummy_tt, "prec_85_count_3d_0_lag:travel_time_weighted_median_dummy_var0 = prec_85_count_3d_0_lag:travel_time_weighted_median_dummy_var1") # Table S10 column (2)
pval_q1_q2 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin1 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin2") # Table S10 column (3)
pval_q1_q3 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin1 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin3") # Table S10 column (3)
pval_q1_q4 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin1 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin4") # Table S10 column (3)
pval_q2_q3 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin2 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin3") # Table S10 column (3)
pval_q2_q4 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin2 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin4") # Table S10 column (3)
pval_q3_q4 <- linearHypothesis(ols_fe_dhs_cbd_quart_tt_bin, "prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin3 = prec_85_count_3d_0_lag:travel_time_weighted_median_qart_bin4") # Table S10 column (3)

# Convert the p-values in character
pval_median_dummy <- substr(sprintf("%.8f", pval_median_dummy[2,3]), 1, 6) # Table S10 column (2)
pval_q1_q2 <- substr(sprintf("%.8f", pval_q1_q2[2,3]), 1, 6) # Table S10 column (3)
pval_q1_q3 <- substr(sprintf("%.8f", pval_q1_q3[2,3]), 1, 6) # Table S10 column (3)
pval_q1_q4 <- substr(sprintf("%.8f", pval_q1_q4[2,3]), 1, 6) # Table S10 column (3)
pval_q2_q3 <- substr(sprintf("%.8f", pval_q2_q3[2,3]), 1, 6) # Table S10 column (3)
pval_q2_q4 <- substr(sprintf("%.8f", pval_q2_q4[2,3]), 1, 6) # Table S10 column (3)
pval_q3_q4 <- substr(sprintf("%.8f", pval_q3_q4[2,3]), 1, 6) # Table S10 column (3)
...
texreg(model_list,
       ...
       file = "output/Tables/Table_4_ols_fe_dhs_cbd_tt_interact.tex",
       #scalebox = 0.45
)
